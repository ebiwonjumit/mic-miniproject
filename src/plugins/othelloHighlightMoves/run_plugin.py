"""
This script is called by the plugin-wrapper, othelloHighlightMoves.js, which passes down the
...
from othelloHighlightMoves import othelloHighlightMoves
...
plugin = othelloHighlightMoves(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
