"""
This script is called by the plugin-wrapper, othelloPlayerMove.js, which passes down the
...
from othelloPlayerMove import othelloPlayerMove
...
plugin = othelloPlayerMove(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
