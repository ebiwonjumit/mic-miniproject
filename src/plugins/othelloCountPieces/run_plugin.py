"""
This script is called by the plugin-wrapper, othelloCountPieces.js, which passes down the
...
from othelloCountPieces import othelloCountPieces

logger = logging.getLogger('othelloCountPieces')
...
plugin = othelloCountPieces(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
