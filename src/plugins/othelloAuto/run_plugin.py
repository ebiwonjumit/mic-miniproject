"""
This script is called by the plugin-wrapper, othelloAuto.js, which passes down the
...
from othelloAuto import othelloAuto

logger = logging.getLogger('othelloAuto')
...
plugin = othelloAuto(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
