"""
This script is called by the plugin-wrapper, othelloUndo.js, which passes down the
...
from othelloUndo import othelloUndo

logger = logging.getLogger('othelloUndo')
...
plugin = othelloUndo(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
