"""
This script is called by the plugin-wrapper, othelloPlugins.js, which passes down the
...
from othelloPlugins import othelloPlugins

logger = logging.getLogger('othelloPlugins')
...
plugin = othelloPlugins(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
