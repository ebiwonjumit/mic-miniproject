<div class="meta-decorator">
    <div class="name"></div>
    <div class="connection-header" title="Has a src and dst pointer and will be rendered as a connection"><< Connection >></div>
    <div class="attributes-title add-top-border">ATTRIBUTES
