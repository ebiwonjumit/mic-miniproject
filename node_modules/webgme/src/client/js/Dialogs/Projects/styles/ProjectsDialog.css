.projects-dialog .modal-content.in-background {
  ...
  .projects-dialog .modal-content.in-background * {
    opacity: 0; }
.projects-dialog .modal-content .modal-header .user-profile-container {
  opacity: 0.6; }
  .projects-dialog .modal-content .modal-header .user-profile-container a {
    color: black; }
.projects-dialog .modal-content .modal-header .help-text {
  padding-left: 10px;
  opacity: 0.6; }
...
.projects-dialog .modal-content .modal-body {
  ...
  .projects-dialog .modal-content .modal-body table.table.table-projects thead th {
    ...
    .projects-dialog .modal-content .modal-body table.table.table-projects thead th .btn-info-toggle {
      color: grey;
      padding-right: 12px; }
