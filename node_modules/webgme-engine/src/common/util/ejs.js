/*eslint-disable*/
define([], function() {
    console.warn('Do not require ejs from "common/util/ejs" instead use "ejs". The "common/util/ejs" path is deprecated as ' +
    'it is using a version that is not being kept up to date!');
